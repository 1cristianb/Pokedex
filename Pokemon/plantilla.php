...
<main class="p-5 container min-vh-100">
    <a href="javascript:history.back()"> <img src="img/botonVolver.png" style="height: 50px" class="mb-2"></a>
    <div class="row contenido">
    <?php
    $nombre_enviado = $_GET['nombre'];
    $sql="SELECT * from pokemon where pokemon.numero_id = $nombre_enviado ;"; //Consulta de SQL por numero o nombre.
        if($result = mysqli_query($conexion, $sql)){
            while($registro = $result->fetch_assoc()){
                ...
                <div class="col">
                    <div>
                        <h1><?php echo $registro['nombre'];?> <span>N.º<?php echo $registro['numero_id'];?></span></h1>
