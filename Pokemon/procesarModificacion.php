...
$numero_id = isset($_POST["numero_id"]) ? $_POST["numero_id"] : "";
...
$sql = "UPDATE pokedex.pokemon SET descripcion='$descripcion', nombre='$nombre', numero_id='$numero_id',imagen='$imagen' ,tipo='$tipo'  WHERE id ='$id'";
